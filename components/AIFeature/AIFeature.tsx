...
const AIFeature = () => {
    ...
    return (
        <section className='my-8 overflow-hidden relative dark:bg-background bg-base-100 lg:h-[90vh] rounded-[40px] p-5 lg:p-16 gap-10 flex flex-col lg:flex-row-reverse justify-center items-center'>
